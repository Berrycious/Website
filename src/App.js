...
function App() { 
  return (
    <div className="App">
      ...
      <img src="https://github.com/Berrycious/Website/blob/6f9f66f9a16712e1cbd7b19eaf646940ac5955aa/assets/Berrycious_Transparent.png?raw=true" alt="Berrycious Logo" width="300" height="150"></img>
        <h1 id="privacy-policy-of-the-via-development">Privacy Policy of The Via Development</h1>
<p>Here&#39;s the privacy policy and terms that you agree to when adding the <strong>Via Bot</strong> to your server, or by being a member of a server that has the bot. <br></br>This doesn&#39;t replace Discord&#39;s <a href="https://discord.com/terms">Terms of Service</a>, <a href="https://discord.com/guidelines">Community Guidelines</a> and <a href="https://discord.com/privacy">Privacy Policy</a>.</p>
<h2 id="bots-services-and-servers">Bots, Services, and Servers</h2>
<p>The following is a list of bots to which this privacy policy applies.
<ul>
...
<li><strong>Server Manager</strong> - Anyone who has the ability to add a bot to a server or configure the bot for the server. <br></br>This is usually an administrator or moderator</li>
...
<p>We collect data only when you use the economy commands. Type <code>-help</code> and click on <strong>Via Economy</strong> to see the list of economy commands.
<br></br>The following data may be collected and stored when a user runs an economy command to the bot:
<ul>
...
The collects data from the user&#39;s presence activity <strong>only</strong> when they meet all the following criteria:
<ul>
...
To request, delete or opt out from the collection of your activity data, send an email to <a href="mailto:ahmed4baari@gmail.com">ahmed4baari@gmail.com</a> or contact us in our Support Server.
...
<p>These are necessary information for the bot to function properly. They are stored only in the cache and are deleted automatically. They are not stored in the database.</p>
<ul>
